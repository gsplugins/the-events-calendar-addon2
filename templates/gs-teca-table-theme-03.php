...
$table_grid_style = teca_build_table_grid_style( '3', $show_image, $show_title, $show_organizer, $show_venue, $show_links );
?>

<div class="teca-table-style-3">
	<div class="teca-table-style-3-table"<?php echo $table_grid_style ? ' style="' . esc_attr( $table_grid_style ) . '"' : ''; ?>>

		<div class="teca-table-style-3-header" role="row">
			<div class="teca-table-style-3-row teca-table-style-3-row--header">
				<?php if ( $show_image ) : ?>
					<div class="teca-table-style-3-cell teca-table-style-3-image teca-table-event-image" role="columnheader">
						<?php esc_html_e( 'Image', 'the-events-calendar-addon' ); ?>
					</div>
				<?php endif; ?>

				<?php if ( $show_title ) : ?>
					<div class="teca-table-style-3-cell teca-table-style-3-title teca-table-event-title" role="columnheader">
						<?php esc_html_e( 'Title', 'the-events-calendar-addon' ); ?>
					</div>
				<?php endif; ?>

				<?php if ( $show_organizer ) : ?>
					<div class="teca-table-style-3-cell teca-table-style-3-organizer teca-table-event-organizer" role="columnheader">
						<?php esc_html_e( 'Organizer', 'the-events-calendar-addon' ); ?>
					</div>
				<?php endif; ?>

				<?php if ( $show_venue ) : ?>
					<div class="teca-table-style-3-cell teca-table-style-3-venue teca-table-event-venue" role="columnheader">
						<?php esc_html_e( 'Venue', 'the-events-calendar-addon' ); ?>
					</div>
				<?php endif; ?>

				<?php if ( $show_links ) : ?>
					<div class="teca-table-style-3-cell teca-table-style-3-links teca-table-event-links" role="columnheader">
		...
		<div class="teca-table-style-3-body">
			<?php
			foreach ( $events as $event ) :
				...
				<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"<?php echo teca_get_event_filter_attributes_html( $event ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Filter attributes are generated and escaped inside helper. ?>>
					...
					<div class="teca-table-style-3-row">

						<?php if ( $show_image ) : ?>
							<div class="teca-table-style-3-cell teca-table-style-3-image teca-table-event-image">
								<div class="teca-table-style-3-image-wrap teca-event-thumb">
									<?php if ( $event_id ) : ?>
						...
						<?php if ( $show_title ) : ?>
							<div class="teca-table-style-3-cell teca-table-style-3-title teca-table-event-title">
								<?php if ( $event_id ) : ?>
						...
						<?php if ( $show_organizer ) : ?>
							<div class="teca-table-style-3-cell teca-table-style-3-organizer teca-table-event-organizer">
								<?php if ( $event_id ) : ?>
						...
						<?php if ( $show_venue ) : ?>
							<div class="teca-table-style-3-cell teca-table-style-3-venue teca-table-event-venue">
								<?php if ( $event_id ) : ?>
						...
						<?php if ( $show_links ) : ?>
							<div class="teca-table-style-3-cell teca-table-style-3-links teca-table-event-links">
								<?php if ( $event_id ) : ?>
									<?php
