...
<div class="teca-organizer-template teca-organizer-template-layout-2">
	<section class="teca-organizer-l2-hero">
		<div class="teca-organizer-l2-hero-content">
			<span class="teca-organizer-l2-eyebrow"><?php esc_html_e( 'Organizer Showcase', 'the-events-calendar-addon2' ); ?></span>
			<h2 class="teca-organizer-l2-title"><?php esc_html_e( 'Connect With Event Organizers', 'the-events-calendar-addon2' ); ?></h2>
			<p class="teca-organizer-l2-description"><?php esc_html_e( 'Browse organizer profiles, contact information, and event connections in a premium editorial layout.', 'the-events-calendar-addon2' ); ?></p>
		</div>

		<?php if ( $organizer_count > 0 ) : ?>
			<div class="teca-organizer-l2-stat" aria-label="<?php esc_attr_e( 'Organizer statistics', 'the-events-calendar-addon2' ); ?>">
				...
				<span class="teca-organizer-l2-stat-label">
					...
					echo esc_html(
						1 === $organizer_count
							? __( 'Organizer', 'the-events-calendar-addon2' )
							: __( 'Organizers', 'the-events-calendar-addon2' )
					);
					?>
				</span>
			</div>
	...
	<?php if ( empty( $organizers ) ) : ?>
		<div class="teca-organizer-l2-empty">
			<h3 class="teca-organizer-l2-empty-title"><?php esc_html_e( 'No organizers found', 'the-events-calendar-addon2' ); ?></h3>
			<p class="teca-organizer-l2-empty-text"><?php esc_html_e( 'No organizer profiles are available right now.', 'the-events-calendar-addon2' ); ?></p>
		</div>
	<?php else : ?>
		<div class="teca-organizer-l2-list">
			<?php foreach ( $organizers as $organizer ) : ?>
				...
				$row_title        = $title ?: __( 'Organizer', 'the-events-calendar-addon2' );
				...
				<article class="teca-organizer-l2-row"<?php echo $organizer_id ? ' data-organizer-id="' . esc_attr( (string) $organizer_id ) . '"' : ''; ?>>
					<div class="teca-organizer-l2-media">
						...
						<span class="teca-organizer-l2-media-badge"><?php esc_html_e( 'Organizer', 'the-events-calendar-addon2' ); ?></span>
					</div>

					<div class="teca-organizer-l2-content">
						<div class="teca-organizer-l2-top">
							<span class="teca-organizer-l2-role-chip"><?php esc_html_e( 'Organizer', 'the-events-calendar-addon2' ); ?></span>
							...
							<div class="teca-organizer-l2-contact-grid">
								<?php if ( $phone && $phone_digits ) : ?>
									<div class="teca-organizer-l2-contact-item">
										<span class="teca-organizer-l2-contact-label"><?php esc_html_e( 'Phone', 'the-events-calendar-addon2' ); ?></span>
								...
								<?php if ( $email ) : ?>
									<div class="teca-organizer-l2-contact-item">
										<span class="teca-organizer-l2-contact-label"><?php esc_html_e( 'Email', 'the-events-calendar-addon2' ); ?></span>
								...
								<?php if ( $website ) : ?>
									<div class="teca-organizer-l2-contact-item">
										<span class="teca-organizer-l2-contact-label"><?php esc_html_e( 'Website', 'the-events-calendar-addon2' ); ?></span>
