...
foreach ( $events as $event ) :
	...
	<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"<?php echo teca_get_event_filter_attributes_html( $event ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
		...
		<div class="teca-list-style-5-card gs-teca-event-main">

			<?php if ( Helpers::is_visible( $visibility_settings['event_thumbnail'] ?? true ) ) : ?>
				<div class="teca-list-style-5-thumb teca-event-thumb gs-teca-event-img-wrapper">
			...
			<div class="teca-list-style-5-content gs-teca-glass-content">

				<?php if ( Helpers::is_visible( $visibility_settings['event_title'] ?? true ) ) : ?>
					<div class="teca-list-style-5-title teca-event-title">
				...
				if ( $show_organizer || $show_date || $show_venue ) :
					?>
					<div class="teca-list-style-5-meta">
						<?php if ( $show_organizer ) : ?>
							<div class="teca-list-style-5-organizer teca-event-organizer">
						...
						<?php if ( $show_date ) : ?>
							<div class="teca-list-style-5-date teca-event-date">
						...
						<?php if ( $show_venue ) : ?>
							<div class="teca-list-style-5-venue-inline teca-event-venue">
				...
				<?php if ( Helpers::is_visible( $visibility_settings['event_details'] ?? true ) ) : ?>
					<div class="teca-list-style-5-description teca-event-description teca-event-excerpt">
						<div class="teca-list-style-5-desc-inner">
							...
							<?php if ( 'single_page' === $gs_teca_link_type ) : ?>
								<a href="<?php echo esc_url( get_permalink( $event['event_id'] ) ); ?>" class="teca-list-style-5-more">
				...
				<div class="teca-list-meta-action-row">
					<div class="teca-list-category-wrap">
						<?php if ( $show_category ) : ?>
							<div class="teca-list-style-5-cat gs-teca-cat">
