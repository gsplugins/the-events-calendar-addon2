...
$table_grid_style = teca_build_table_grid_style( '2', $show_image, $show_title, $show_organizer, $show_venue, $show_links );
?>

<div class="teca-table-style-2">
<div class="teca-table-style-2-table"<?php echo $table_grid_style ? ' style="' . esc_attr( $table_grid_style ) . '"' : ''; ?>>

	<div class="teca-table-style-2-header" role="row">
	...
	<div class="teca-table-style-2-body">
		<?php
		foreach ( $events as $event ) :
			...
			<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"<?php echo teca_get_event_filter_attributes_html( $event ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				...
				<div class="teca-table-style-2-row">

					<?php if ( $show_image ) : ?>
						<div class="teca-table-style-2-cell teca-table-style-2-image teca-table-event-image">
							<div class="teca-table-style-2-image-wrap teca-event-thumb">
								<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_title ) : ?>
						<div class="teca-table-style-2-cell teca-table-style-2-title teca-table-event-title">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_organizer ) : ?>
						<div class="teca-table-style-2-cell teca-table-style-2-organizer teca-table-event-organizer">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_venue ) : ?>
						<div class="teca-table-style-2-cell teca-table-style-2-venue teca-table-event-venue">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_links ) : ?>
						<div class="teca-table-style-2-cell teca-table-style-2-links teca-table-event-links">
							<?php if ( $event_id ) : ?>
							<?php
