...
$item_partial = Template_Loader::locate_template( 'events/partials/event-layout-2-item.php' );
...
?>
<div
	class="teca-events-layout-2-panel <?php echo esc_attr( $panel_class ); ?><?php echo $is_active ? ' is-active' : ''; ?>"
	id="teca-events-layout-2-panel-<?php echo esc_attr( $group_key ); ?>"
...
>
	...
	<?php else : ?>
		<div class="teca-events-layout-2-list">
