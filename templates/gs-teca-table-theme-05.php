...
$table_grid_style = teca_build_table_grid_style( '5', $show_image, $show_title, $show_organizer, $show_venue, $show_links );
?>

<div class="teca-table-style-5">
<div class="teca-table-style-5-table"<?php echo $table_grid_style ? ' style="' . esc_attr( $table_grid_style ) . '"' : ''; ?>>

	<div class="teca-table-style-5-header" role="row">
		<div class="teca-table-style-5-row teca-table-style-5-row--header">
			<?php if ( $show_image ) : ?>
				<div class="teca-table-style-5-cell teca-table-style-5-image teca-table-event-image" role="columnheader">
					<?php esc_html_e( 'Image', 'the-events-calendar-addon' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( $show_title ) : ?>
				<div class="teca-table-style-5-cell teca-table-style-5-title teca-table-event-title" role="columnheader">
					<?php esc_html_e( 'Title', 'the-events-calendar-addon' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( $show_organizer ) : ?>
				<div class="teca-table-style-5-cell teca-table-style-5-organizer teca-table-event-organizer" role="columnheader">
					<?php esc_html_e( 'Organizer', 'the-events-calendar-addon' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( $show_venue ) : ?>
				<div class="teca-table-style-5-cell teca-table-style-5-venue teca-event-venue" role="columnheader">
					<?php esc_html_e( 'Venue', 'the-events-calendar-addon' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( $show_links ) : ?>
				<div class="teca-table-style-5-cell teca-table-style-5-links teca-table-event-links" role="columnheader">
	...
	<div class="teca-table-style-5-body">
		<?php
		foreach ( $events as $event ) :
			...
			<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"<?php echo teca_get_event_filter_attributes_html( $event ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				...
				<div class="teca-table-style-5-row teca-table-style-5-card">

					<?php if ( $show_image ) : ?>
						<div class="teca-table-style-5-cell teca-table-style-5-image teca-table-event-image">
							<div class="teca-table-style-5-image-wrap teca-event-thumb">
								<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_title ) : ?>
						<div class="teca-table-style-5-cell teca-table-style-5-title teca-event-title">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_organizer ) : ?>
						<div class="teca-table-style-5-cell teca-table-style-5-organizer teca-event-organizer">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_venue ) : ?>
						<div class="teca-table-style-5-cell teca-table-style-5-venue teca-event-venue">
							<?php if ( $event_id ) : ?>
					...
					<?php if ( $show_links ) : ?>
						<div class="teca-table-style-5-cell teca-table-style-5-links teca-table-event-links">
							<?php if ( $event_id ) : ?>
							<?php
